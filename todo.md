...
- [x] Revisar el estado Git y las reglas de exclusión antes de publicar el código del proyecto.
- [x] Preparar una confirmación local que excluya credenciales, respaldos y archivos generados de la publicación.
- [x] Publicar el proyecto en el repositorio Git autorizado y verificar que la rama remota contiene la versión esperada.
